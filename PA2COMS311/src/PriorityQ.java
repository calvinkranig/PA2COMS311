...
public class PriorityQ {
		...
		private ArrayList<NodeGeneric> heapArray;
		...
		public PriorityQ(int size) {
			heapArray = new ArrayList<NodeGeneric>(size+1); // pretty sure the max # of
												// strings is 200
			heapArray.add(null);
			heapSize = 0;
		}
		 ...
		 */
		public NodeGeneric extractMin() {
			if (this.isEmpty()) {
				return null;
			}
			NodeGeneric max = this.returnMin(); // save string for the return
		 ...
		 */
		public NodeGeneric getValue(int i) {
		...
		private void swap(int i, int j) {
			...
			NodeGeneric temp = heapArray.get(i);
